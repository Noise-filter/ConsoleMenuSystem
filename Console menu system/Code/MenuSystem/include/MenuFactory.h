...
namespace MenuSystem
{
	...
	private:
		...
		{
			MenuFactory factory;
			auto button = std::make_shared<Button<Owner>>(owner, nullptr);
		...
		{
			MenuFactory factory;
			auto checkbox = std::make_shared<Checkbox<Owner>>(owner, nullptr);
		...
		{
			MenuFactory factory;
			auto inputField = std::make_shared<InputField<Owner>>(owner, nullptr);
		...
		{
			MenuFactory factory;
			auto inputField = std::make_shared<InputFieldPassword<Owner>>(owner, nullptr);
			inputField->SetText(factory.GetString(it, "text"));
			inputField->SetSize(factory.GetSize(it));
			inputField->SetPosition(factory.GetPos(it));
			inputField->SetColor(factory.GetTextColor(it, "color"));
		...
		{
			MenuFactory factory;
			auto list = std::make_shared<List<Owner>>(owner, nullptr);
		...
		{
			MenuFactory factory;
			auto list = std::make_shared<CheckboxList<Owner>>(owner, nullptr);
			list->SetText(factory.GetString(it, "text"));
			list->SetSize(factory.GetSize(it));
			list->SetPosition(factory.GetPos(it));
			list->SetColor(factory.GetTextColor(it, "color"));
